...
use DB;
use App\Model\Ugdegree;

class MstUgDegreeController extends Controller
{
...
/* Ug Degree For List All in Get Methode */
/* Start */ 
	public function UgDegreeListAll()
	{

		$result = Ugdegree::select('mst_ugdegree_id','mst_ugdegree_detail')
			->where('mst_ugdegree_status', '1')		
			->get();
