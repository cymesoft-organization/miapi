...
use DB;
use App\Model\FatherOccupation;

class MstFatherOccupationController extends Controller
{
...
/* Start */ 
	public function FatherOccupationListAll()
	{

		$result = FatherOccupation::select('mst_foccupation_id','mst_foccupation_detail')
			->where('mst_foccupation_status', '1')		
			->get();
