...
use DB;
use App\Model\Sister;

class MstSisterController extends Controller
{
...
/* Start */ 
	public function SisterListAll()
	{

		$result = Sister::select('mst_sister_id','mst_sister_detail')
			->where('mst_sister_status', '1')		
			->get();
