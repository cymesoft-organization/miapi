...
use DB;
use App\Model\Brother;

class MstBrotherController extends Controller
{
...
/* Start */ 
	public function BrotherListAll()
	{

		$result = Brother::select('mst_brother_id','mst_brother_detail')
			->where('mst_brother_status', '1')		
			->get();
