...
use DB;
use App\Model\Horoscope;

class MstHoroscopeController extends Controller
{
...
/* Horoscope For List All in Get Methode */
/* Start */ 
	public function HoroscopeListAll()
	{

			
		$result = Horoscope::select('mst_horoscope_id','mst_horoscope_detail')
			->where('mst_horoscope_status', '1')		
			->get();
