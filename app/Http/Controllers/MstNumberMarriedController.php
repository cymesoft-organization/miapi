...
use DB;
use App\Model\NumberMarried;

class MstNumberMarriedController extends Controller
{
...
/* Number Of Married For List All in Get Methode */
/* Start */ 
	public function NumberMarriedListAll()
	{

		$result = NumberMarried::select('mst_married_id','mst_married_detail')
			->where('mst_married_status', '1')		
			->get();
