...
class MstMotherTongueController extends Controller
{
	
	
/* Mother Tongue For Inserted in Post Methode */
/* Start */ 	
...
/* Mother Tongue For List All in Get Methode */
/* Start */ 
	public function MotherTongueListAll()
	{

		$result = MotherTongue::select('mst_mtongue_id','mst_parent_id','mst_mtongue_detail')
		...
		if (count($result) != 0)
		{
			...
			foreach ($result as  $motherTongue) {
				...
				$result1 = MotherTongue::select('mst_mtongue_id','mst_parent_id','mst_mtongue_detail')
						->where('mst_parent_id', $motherTongue['mst_mtongue_id'])
						->where('mst_mtongue_status', '1')										
						->get();				
				...
				if (count($result1) != 0)
				{
					...
					$result[] = array($motherTongue['mst_mtongue_detail'] => $result1);
