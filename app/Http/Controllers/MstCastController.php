...
class MstCastController extends Controller
{
...
/* Start */ 
	public function CastListAll(Request $request)
	{
		...
		$result = Caste::select('mst_caste_id','mst_religion_id','mst_caste_detail')
			->where('mst_religion_id', $religionId)
			->where('mst_caste_status', '1')			
			->get();
